    ...
    <!-- <div class="page-wrapper" id="introduce">
      <div class="page-div">
        ...
        <p>
          ...
          <a href="https://vuejs.org/guide/introduction.html" target="_blank">Vue</a>，该框架的中文文档页面暂时无法访问，翻阅时请做好心理准备。本次实验使用的前端框架是
          <a href="https://www.antdv.com/components/overview-cn/" target="_blank">Antdv</a>，该框架是由蚂蚁金融开发的Ant-design框架修改而来，适用于我国各大信息系统。
        </p>
        <p>
          本次实验包括以下内容：
        </p>
...
import UserStore from "./UserStore.vue";
</script>
